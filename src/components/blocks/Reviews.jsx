                ...
                <reviewsCSS.ServicesContainer>
                    ...
                    <reviewsCSS.Reviews>
                        ...
                        <reviewsCSS.Review>
                            ...
                            <reviewsCSS.RewiewInfo>
                                <reviewsCSS.RewiewDesk>
                                    <span>Долго присматривался, посмотрел всех продавцов, сделали скидку, пришёл и приобрёл, сразу установили.</span>
                                </reviewsCSS.RewiewDesk>
                                <reviewsCSS.ReviewName>
                        ...
                        <reviewsCSS.Review>
                            ...
                            <reviewsCSS.RewiewInfo>
                                <reviewsCSS.RewiewDesk>
                                    <span>Очень отзывчивый продавец, всё объяснил, показал! Побольше бы таких ребят 🤗</span>
                                </reviewsCSS.RewiewDesk>
                                <reviewsCSS.ReviewName>
